...
const LockScreen = ({ onUnlock }) => {
    ...
    useEffect(() => {
        const timer = setInterval(() => {
            ...
            if (newTimeLeft.days === 0 && newTimeLeft.hours === 0 &&
                ...
                setCanUnlock(true)
                // Switch to Happy Birthday music when unlock button appears
    ...
    const handleUnlockClick = () => {
        // Play Happy Birthday music for a moment before transitioning
        changeSection('unlock')
        setTimeout(() => {
            onUnlock()
        }, 500)
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-baby-blue via-soft-pink-light to-soft-pink relative overflow-hidden">
            ...
            <div className="text-center px-4 sm:px-6 w-full max-w-4xl mx-auto relative z-10">
                {!canUnlock ? (
                    <motion.div
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8 max-w-2xl mx-auto">
                            {[
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center gap-2 mb-10">
                            ...
                            <div className="flex justify-center gap-1 md:gap-3 overflow-hidden">
                                {Array.from("Birthday").map((char, i) => (
                                    <motion.span
                                        key={i}
                                        initial={{ y: 100, rotate: -10 }}
                                        animate={{ y: 0, rotate: 0 }}
                        ...
                        {/* "Akanksha" - GOLD FOIL TEXT (Reusing the premium style) */}
                        <motion.h1
